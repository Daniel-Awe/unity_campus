...
public class PlayFabLogin : MonoBehaviour
{
       ...
       (string.IsNullOrEmpty(PlayFabSettings.staticSettings.TitleId))
        {
           ...
           this can be skipped.
            */
            PlayFabSettings.staticSettings.TitleId = "9367E";
        }
    ...
    {
        Debug.Log("Congratulations, you made your first successful APIcall!");
    }
    private void OnLoginFailure(PlayFabError error)
    {
        Debug.LogWarning("Something went wrong with your first APIcall. :(");
